...
export class LcuBillingPlanViewElementComponent extends LcuElementComponent<LcuBillingPlanViewContext> implements OnChanges, OnInit {
  //  Fields
  ...
  protected loadBillingOptions(){
    ...
    this.BillingPlanOptions = [
      ...
      "PlanFeatures": "IoT Management|Shared Cloud|10 Devices|60 second Data Velocity|3 Days of Data Retention",
      "TrialPeriodDays": 0
      },
      {
      "Description": "",
      ...
      "HeaderName": "Fathym | IoT Ensemble",
      "LicenseName": "Fathym IoT",
      "PlanFeatures": "IoT Management|Shared Cloud|50 Devices|30 second Data Velocity|7 Days of Data Retention",
      "TrialPeriodDays": 0
      },
      {
      "Description": "",
